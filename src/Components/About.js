...
<div class="card-deck">
  <div class="card">
    <img class="card-img-top" src="https://i.gifer.com/Ts3R.gif" alt="Card image cap" />
    <div class="card-body">
...
<div class="card">
  <img class="card-img-top" src="https://media.giphy.com/media/fedryX7dMGMe6lgqDm/giphy.gif" alt="Card image cap" />
    <div class="card-body">
  ...
  <div class="card">
    <img class="card-img-top" src="https://media.giphy.com/media/26tn33aiTi1jkl6H6/giphy.gif" alt="Card image cap" />
    <div class="card-body">
  ...
  <div class="card">
  <img class="card-img-top" src="https://media.giphy.com/media/QzBNRXuAw6atO1Sger/giphy.gif" alt="Card image cap" />
    <div class="card-body">
